  ...
  def process(self,tool):
    ...
    # for i,t in enumerate(tool):
      ...
      if cmd == last_cmd:
        ...
        if   last_cmd == 1 and len(path) < 3 : self.drill(xarr[0],yarr)
        elif last_cmd == 0                   : self.move(xarr,yarr)
        elif last_cmd == 1                   : self.mill(xarr,yarr)
        elif last_cmd == 2                   : self.circle(xarr,yarr)
